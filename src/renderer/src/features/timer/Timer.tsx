...
export function Timer({ onFinish, isAuthenticated }: TimerProps) {
    ...
    return (
        <div className="flex flex-col h-full bg-white text-zinc-900 overflow-hidden font-sans">
            ...
            <main className="flex-1 flex items-center justify-center">
                <div className={`text-8xl font-bold tracking-tighter tabular-nums transition-colors duration-300 ${isRunning ? 'text-zinc-900' : 'text-zinc-200'}`}>
                    {formatTime(seconds)}
                </div>
            </main>
